...
class RandomAgent(core.Agent):
    ...
    def __init__(self, action_space, reward_fn, observation_space, default_action=None):
    ...
    """
        ...
        super(RandomAgent, self).__init__(action_space, reward_fn, observation_space)
