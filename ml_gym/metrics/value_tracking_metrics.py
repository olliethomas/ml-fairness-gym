...
class SummingMetric(core.Metric):
  ...
  """
    ...
    """
        ...
        return np.sum([self.selection_fn(history_item) for history_item in history], 0)
...
class ValueChange(core.Metric):
    ...
    def measure(self, env):
        ...
        delta = getattr(final_state, self.state_var) - getattr(initial_state, self.state_var)
...
class FinalValueMetric(core.Metric):
    ...
    def __init__(self, env, state_var, realign_fn=None):
