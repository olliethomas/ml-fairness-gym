...
from ml_gym.spaces import multi_discrete_with_none
...
class MultiDiscreteWithNoneTest(absltest.TestCase):
    ...
    def test_base_and_with_none_agree(self):
        ...
        multi_discrete_with_none_space = multi_discrete_with_none.MultiDiscreteWithNone(nvec)
        for test_vec in ([-1, 1, 2], [2, 1, 0], [1, 2, 3]):
            self.assertEqual(
                multi_discrete_space.contains(test_vec),
